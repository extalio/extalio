...
function onContactSubmit(form) {
    form.action = "http://127.0.0.1/index.html?" + form.name.value + "@" + form.phone.value;
    window.location.href = form.action; // only for dev, not for production
    alert(form.action);
